...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 10 nov. 2025 à 19:58
...
INSERT INTO `demande` (`id_demande`, `id_client`, `description`, `date_demande`, `statut`) VALUES
(1, 1234, '  J\'aimerais déménager de douala à bandjoun le 15/12/25. J\'aurais  besoin d\'un déménageur.\r\n', '2025-11-10 15:16:17', 'ouverte');
...
INSERT INTO `proposition` (`id_proposition`, `id_demande`, `id_demenageur`, `prix_estime`, `statut`) VALUES
(1, 1, 1234, 500.00, 'en_attente');
...
INSERT INTO `question` (`id_question`, `id_demande`, `id_auteur`, `contenu_question`, `date_question`) VALUES
(1, 1, 1234, 'avez vous un ascenseur dans votre logement', '2025-11-11 15:22:36');
...
(1234, 'kongape', 'guy ', 'gk@gmail.com', 'rt', NULL),
(5678, 'kamga ', 'merveille', 'mk@gmail.com', 'jt', NULL);
...
--
ALTER TABLE `utilisateur`
  MODIFY `id_utilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5679;
